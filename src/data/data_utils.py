...
def filter_by_length(
    source_tokens_list: List[torch.Tensor],
...
def pad_and_mask_sequence(
    ...
    """
    source_padded_tokens = pad_sequence(
        source_tokens, batch_first=True, padding_value=padding_value
    )
    target_padded_tokens = pad_sequence(
        target_tokens, batch_first=True, padding_value=padding_value
    )
