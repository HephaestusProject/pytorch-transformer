...
from utils import root_dir, dataset_config, tokenizer_config, read_lines
...
tokenizer = SentencePieceBPETokenizer(f'{tokenizer_config.tokenizer_name}-vocab.json', f'{tokenizer_config.tokenizer_name}-merges.txt')
